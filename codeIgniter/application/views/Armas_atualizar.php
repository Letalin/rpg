                ...
                <div class="col-sm-4 offset-sm-4">
                    <form method="post" action="<?php echo base_url("Armas/atualizar/" . $arma->id_arma); ?>">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nomeie sua espada" value="<?php echo $arma->nome ?>" name="nome">
                        </div>
                        <div class="form-group">
                            <label>Dano Perfurante</label>
                            <input type="text" class="form-control" placeholder="Furar" value="<?php echo $arma->dano_perfuracao ?>" name="dano_perfuracao">
                        </div>
                        <div class="form-group">
                            <label for="">Dano Esmagador</label>
                            <input type="text" class="form-control" placeholder="Esmagar" value="<?php echo $arma->dano_esmagador ?>" name="dano_esmagador">
                        </div>
                        <div class="form-group">
                            <label>Dano Cortante</label>
                            <input type="text" class="form-control" placeholder="Cortar" value="<?php echo $arma->dano_corte ?>" name="dano_corte">
                        </div>
                        <div class="form-group">
                            <label>Imagem</label>
